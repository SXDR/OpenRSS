...
parser.add_argument('--data_dir', '-dr', type=str, default='./dataset/MFNet_dataset')
parser.add_argument('--model_dir', '-wd', type=str, default='./test/')
parser.add_argument('--vit_name', type=str,
                    default='vit_h', help='select one vit model')
parser.add_argument('--data_name', type=str,
                    default='get_palette_MF')
parser.add_argument('--ckpt', type=str, default='./sam_vit_h_4b8939.pth',  # sam_vit_l_0b3195 sam_vit_b_01ec64
...
if __name__ == '__main__':
    class_num = ["Background", "Car", "Person", "Bike", "Curve", "Car Stop", "Guardrail", "Color Cone", "Bump"]
    text_list = []
    qz = "a pohot of "
    for i in class_num:
    ...
    with torch.no_grad():
        for it, (images, labels, names, th) in enumerate(test_loader):
            ...
            # print(logits.argmax(1).cpu().numpy().shape)
